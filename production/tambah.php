            ...
            <div class="x_content">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-5 col-sm-6 col-xs-12">
                    <input name="Account" type="text" id="Account" class="form-control col-md-7 col-xs-12">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-5 col-sm-6 col-xs-12">
                    <input name="NamaBarang" type="text" id="NamaBarang" class="form-control col-md-7 col-xs-12">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-5 col-sm-6 col-xs-12">
                    <input name="SAT" type="text" id="SAT" class="form-control col-md-7 col-xs-12">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-5 col-sm-6 col-xs-12">
                    <input name="SaldoAwal" type="text" id="SaldoAwal" class="form-control col-md-7 col-xs-12">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-5 col-sm-6 col-xs-12">
                    <input name="LPB" type="text" id="LPB" class="form-control col-md-7 col-xs-12">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-5 col-sm-6 col-xs-12">
                    <input name="BKB" type="text" id="BKB" class="form-control col-md-7 col-xs-12">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-5 col-sm-6 col-xs-12">
                    <input name="SaldoAkhir" type="text" id="SaldoAkhir" class="form-control col-md-7 col-xs-12">
                  </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-md-offset-4">
                  <button name="kembali" type="submit" class="btn btn-danger">Kembali</button>
